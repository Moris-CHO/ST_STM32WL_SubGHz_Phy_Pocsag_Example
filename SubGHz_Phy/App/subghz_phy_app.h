...
#define USE_MODEM_FSK   1     //This example is using only FSK. Must set to 1.

#define RF_FREQUENCY                                446862500 /* Hz */
...
#define FSK_FDEV                                    4000     /* Hz */
#define FSK_DATARATE                                1200     /* bps */
#define FSK_BANDWIDTH                               12500    /* Hz */
